...
namespace ProjectDoxen.Logic.CredentialManager
{
    ...
    public static class CredentialManager
    {
        ...
        private static void GetCredentialsFromOutputBuffer(ref string user, ref string password, ref string domain, nint outCredBuffer, uint outCredSize)
        {
            int maxUserName = 100;
            int maxDomain = 100;
            int maxPassword = 100;
        ...
        private static void GetInputBuffer(string user, out nint inCredBuffer, out int inCredSize)
        {
        ...
        internal static bool PromptForCredentials(string target, ref bool save, ref string user, out string password, out string domain, nint parentWindowHandle = default)
        {
        ...
        internal static bool PromptForCredentials(string target, ref bool save, string message, string caption, ref string user, out string password, out string domain, nint parentWindowHandle = default)
        {
            var credUI = new NativeCode.CredentialUIInfo
            {
                hwndParent = parentWindowHandle,
        ...
        public static NetworkCredential PromptForCredentials(string target, ref bool save, nint parentWindowHandle = default)
        {
        ...
        /// <returns>NetworkCredential object containing the user name, </returns>
        public static NetworkCredential PromptForCredentials(string target, ref bool save, string message, string caption, nint parentWindowHandle = default)
        {
            string username = "", password, domain;
        ...
        /// <returns>NetworkCredential object containing the user name, </returns>
        public static NetworkCredential PromptForCredentials(string target, ref bool save, string message, string caption, string defaultUserName, nint parentWindowHandle = default)
        {
        ...
        public static NetworkCredential PromptForCredentialsConsole(string target)
        {
            ...
            // Prompt the user
            NativeCode.CredentialUIReturnCodes returnCode = NativeCode.CredUICmdLinePromptForCredentials(target, nint.Zero, 0, userID, 100, userPassword, 100, ref save, flags);
        ...
        public static ICredential GetICredential(string target, CredentialType type = CredentialType.Generic)
        {
            ...
            bool isSuccess = NativeCode.CredRead(target, (uint)type, 0, out nCredPtr);
            if (!isSuccess)
            {
                var lastError = Marshal.GetLastWin32Error();
                if (lastError == (int)NativeCode.CredentialUIReturnCodes.NotFound)
